...
def gse171524_dataset_fetch():
    ...
    return ftp_url, ftp_directory, filename, local_filename, extract_folder

def main():
    # Step 1: Fetch the Dataset
    ftp_url, ftp_directory, filename, local_filename, extract_folder = gse171524_dataset_fetch()
